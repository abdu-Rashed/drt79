...
class LogintoAccountWidget extends StatefulWidget {
  const LogintoAccountWidget({super.key});

  @override
  State<LogintoAccountWidget> createState() => _LogintoAccountWidgetState();
}

class _LogintoAccountWidgetState extends State<LogintoAccountWidget>
    with TickerProviderStateMixin {
  late LogintoAccountModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LogintoAccountModel());
                              ...
                              child: RichText(
                                ...
                                text: TextSpan(
                                  children: [
                                    TextSpan(
                                      text: FFLocalizations.of(context).getText(
                                        'xcmfqj6r' /* Don't have an account ? */,
                                      ),
                                      style: TextStyle(
                                        color: FlutterFlowTheme.of(context)
                                            .secondaryBackground,
